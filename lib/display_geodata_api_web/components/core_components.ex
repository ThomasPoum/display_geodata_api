defmodule DisplayGeodataApiWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DisplayGeodataApiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DisplayGeodataApiWeb.Gettext, "errors", msg, opts)
    end
  end
